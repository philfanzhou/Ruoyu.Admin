...
public sealed class RuoyuConsulKvLoader
{
    private const string CommentPropertyName = "__comment";
    private readonly RuoyuConsulOptions _options;
    private readonly HttpMessageHandler? _handler;

    public RuoyuConsulKvLoader(RuoyuConsulOptions options, HttpMessageHandler? handler = null)
    {
        _options = options;
        _handler = handler;
    }

    public RuoyuConsulKvLoadResult Load()
    {
        ...
        return new RuoyuConsulKvLoadResult(snapshot, prefixes);
    }

    public static IReadOnlyList<string> BuildPrefixes(RuoyuConsulOptions options)
    {
        return new[] { options.KvPrefix };
    }
...
public sealed record RuoyuConsulKvLoadResult(
